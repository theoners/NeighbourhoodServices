...
namespace NeighbourhoodServices.Data.Migrations
{
    ...
    [Migration("20200422190935_Rating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeighbourhoodServices.Data.Models.Announcement", b =>
                {
            ...
            modelBuilder.Entity("NeighbourhoodServices.Data.Models.ApplicationRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NeighbourhoodServices.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NeighbourhoodServices.Data.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NeighbourhoodServices.Data.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("NeighbourhoodServices.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NeighbourhoodServices.Data.Models.Comment", b =>
                {
                    b.HasOne("NeighbourhoodServices.Data.Models.Announcement", "Announcement")
                        .WithMany("Comments")
